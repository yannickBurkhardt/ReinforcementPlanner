...
actor_model_path = 'experiments/05_ppo/actor-26000.pth'
critic_model_path = 'experiments/05_ppo/critic-26000.pth'
...
def evaluate():
    ...
    for i in range(3):
        ...
        while True:
            ...
            next_states, rewards, dones, _ = env.step(actions[0]) # Perform action and get new state and reward
